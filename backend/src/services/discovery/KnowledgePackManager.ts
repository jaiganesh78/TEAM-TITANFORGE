export interface KnowledgePack {
  ...
  suggestedDiscoveryOrder: string[];
...
export const INDUSTRY_KNOWLEDGE_PACKS: Record<string, KnowledgePack> = {
  SaaS: {
    industry: 'SaaS',
...
export class KnowledgePackManager {
  static getPack(industry: string): KnowledgePack {
    return INDUSTRY_KNOWLEDGE_PACKS[industry] || INDUSTRY_KNOWLEDGE_PACKS['SaaS'];
  }

  static listPacks(): string[] {
    return Object.keys(INDUSTRY_KNOWLEDGE_PACKS);
  }
}
