...
export interface EngineConfidenceRequirements {
  minimum: number;        // Below this, engine refuses to run
  recommended: number;    // Below this, outputs marked low-confidence
}
...
export interface EngineContract {
  ...
  produces: string[];
  consumes: string[];
  writesTo: string[];      // DB models this engine writes
  readsFrom: string[];     // DB models this engine reads

  // Knowledge & Context Requirements
  knowledgeDependencies: GrowthDomain[];
  requiredContext: string[];
  requiredKpis: string[];

  // Quality Thresholds
  confidenceRequirements: EngineConfidenceRequirements;

  // Failure & Escalation
  failureConditions: string[];
  escalationRules: string[];

  // Debate Engine Integration (future)
  futureDebateParticipants: string[];

  supportedDomains: GrowthDomain[];
  futureAIProvider: string;
}

// ================================================================
// STRATEGY ENGINE
// ================================================================
export const StrategyEngineContract: EngineContract = {
  id: 'strategy-engine',
...
// MARKETING ENGINE
// ================================================================
export const MarketingEngineContract: EngineContract = {
  id: 'marketing-engine',
...
// ================================================================
export const LeadGenerationEngineContract: EngineContract = {
...
// SALES ENGINE
// ================================================================
export const SalesEngineContract: EngineContract = {
  id: 'sales-engine',
...
// ANALYTICS ENGINE
// ================================================================
export const AnalyticsEngineContract: EngineContract = {
  id: 'analytics-engine',
...
// ================================================================
export const CustomerSuccessEngineContract: EngineContract = {
...
// Registry
export const ALL_ENGINE_CONTRACTS: EngineContract[] = [
  StrategyEngineContract,
  MarketingEngineContract,
  LeadGenerationEngineContract,
  SalesEngineContract,
  AnalyticsEngineContract,
  CustomerSuccessEngineContract
];

export function getEngineContract(id: string): EngineContract | undefined {
  return ALL_ENGINE_CONTRACTS.find(e => e.id === id);
}
