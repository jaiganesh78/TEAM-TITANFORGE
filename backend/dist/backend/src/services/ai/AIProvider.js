...
exports.AIProviderFactory = exports.MockAIProvider = exports.LocalLLMProvider = exports.GeminiProvider = void 0;
class GeminiProvider {
    ...
    async generateChatCompletion(messages, temperature = 0.2) {
        if (!this.apiKey) {
    ...
    async extractStructuredData(text, schemaDescription) {
        if (!this.apiKey) {
            throw new Error('GEMINI_API_KEY is not defined.');
        }
        const { GoogleGenAI } = require('@google/generative-ai');
