...
class CoverageEngine {
     ...
     */
    static async calculateCoverage(businessId, activeQuestions) {
        ...
        const metaList = await prisma_1.prisma.answerMetadata.findMany({
            where: { businessId }
        });
        const metaMap = {};
        ...
        for (const q of activeQuestions) {
            ...
            const val = QuestionEngine_1.QuestionEngine.extractValue(business, q.dbPath);
...
exports.CoverageEngine = CoverageEngine;
