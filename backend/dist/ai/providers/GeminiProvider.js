...
class GeminiProvider {
    ...
    getMockMarketingRecommendations() {
        return {
            recommendations: [
                {
    ...
    getMockAnalyticsRecommendations() {
        return {
            recommendations: [
                {
    ...
    getMockExecutiveAccountSummary() {
        return {
            currentHealth: 88.0,
    ...
    getMockCustomerRecommendations() {
        return {
            recommendations: [
                {
    ...
    getMockExecutiveRecommendations() {
        return {
            recommendations: [
                {
    ...
    getMockExecutiveDecisionSimulation() {
        return {
