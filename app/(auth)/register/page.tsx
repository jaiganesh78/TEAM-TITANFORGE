...
import { CheckCircle2, Key, Mail, Target, User, Building } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen w-full flex bg-gradient-to-br from-[#1F4068] via-[#0F1829] to-[#070C16] relative overflow-hidden select-none font-sans">
      {/* MOBILE ONLY BACKGROUND GRADIENTS (Hidden on desktop) */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 lg:hidden">
        <div className="absolute top-[-10%] left-[-10%] size-[400px] rounded-full bg-[#1f4068]/10 blur-[120px]" />
        <div className="absolute bottom-[-10%] right-[-10%] size-[500px] rounded-full bg-[#F4D03F]/5 blur-[130px]" />
        <div
          aria-hidden="true"
        ...
        <div className="space-y-10 z-10">
          ...
          <div className="max-w-md space-y-5">
            ...
            >
              ...
              <p className="text-sm text-slate-355 leading-relaxed font-normal">
            ...
            >
              {[
                ...
                <div className="flex items-start gap-3" key={text}>
                  ...
                  <span className="text-sm text-slate-300 font-normal leading-relaxed">
                    {text}
                  </span>
                </div>
              ))}
          ...
          >
            ...
            <div className="text-left space-y-2">
              ...
              <p className="text-sm text-[#64748B] font-medium leading-relaxed">
                Initialize your business twin. Register below using your corporate email address.
              </p>
            </div>
            ...
            <form className="space-y-4 pt-1" onSubmit={handleRegister}>
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  placeholder="e.g. TitanForge LLC"
                  type="text"
                  value={company}
                  required
                />
